...
Transformer::Transformer(int power, int hp)
{
    _Name = "Optimus Prime";
    _Power = power;
    _HP = hp;
...
{
    std::cout << "Method: transform, Class: Transformer" << std::endl;
}

void Transformer::ability() const
{
    std::cout << "Method: ability, Class: Transformer" << std::endl;
}

void Transformer::ulta() const
{
    std::cout << "Method: ulta, Class: Transformer" << std::endl;
}
// Sets
